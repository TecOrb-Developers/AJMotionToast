...
import com.movingtoast.databinding.FullColorToastBinding
import com.movingtoast.databinding.MovingToastBinding
...
class MovingToast {
    companion object {
        ...
        // all toast CTA
        fun createToast(
            context: Activity, title: String? = null, message: String,
            style: MovingToastStyle, position: Int, duration: Long, font: Typeface?) {
            layoutInflater = LayoutInflater.from(context)
            val binding = MovingToastBinding.inflate(layoutInflater)
            ...
            when (style) {
                ...
                MovingToastStyle.SUCCESS -> {
                    ...
                    DrawableCompat.setTint(DrawableCompat.wrap(binding.customToastImage.drawable),
                    ...
                    binding.customToastText.text =
                        if (title.isNullOrBlank()) MovingToastStyle.SUCCESS.getName() else title
                ...
                MovingToastStyle.ERROR -> {
                    ...
                    binding.customToastText.text =
                        if (title.isNullOrBlank()) MovingToastStyle.ERROR.getName() else title
                ...
                MovingToastStyle.WARNING -> {
                    ...
                    binding.customToastText.text =
                        if (title.isNullOrBlank()) MovingToastStyle.WARNING.getName() else title
                ...
                MovingToastStyle.INFO -> {
                    ...
                    binding.customToastText.text =
                        if (title.isNullOrBlank()) MovingToastStyle.INFO.getName() else title
                ...
                MovingToastStyle.DELETE -> {
                    ...
                    binding.customToastText.text =
                        if (title.isNullOrBlank()) MovingToastStyle.DELETE.getName() else title
...
//                    binding.animate().alpha(0f).duration = 3000
                ...
                MovingToastStyle.NO_INTERNET -> {
                    ...
                    binding.customToastText.text =
                        if (title.isNullOrBlank()) MovingToastStyle.NO_INTERNET.getName() else title
